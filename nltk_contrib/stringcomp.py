...
def demo ():
    print("Comparison between 'python' and 'python': {0:0.2f}".format(stringcomp("python", "python")))
    print("Comparison between 'python' and 'Python': {0:0.2f}".format(stringcomp("python", "Python")))
    print("Comparison between 'NLTK' and 'NTLK': {0:0.2f}".format(stringcomp("NLTK", "NTLK")))
    print("Comparison between 'abc' and 'def': {0:0.2f}".format(stringcomp("abc", "def")))
    ...
    for country in ["canada", "brazil", "egypt", "thailand", "austria"]:
        ...
        if score > max_score:
            best_match = country
            max_score = score
        print("(comparison between 'australia' and '{0}': {1:0.2f})".format(country, score))
    print("Word most similar to 'australia' is '{0}' (score: {1:0.2f})".format(best_match, max_score))
